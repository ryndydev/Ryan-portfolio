...
export const projects: Project[] = [
  ...
  },
  {
    ...
    features: [
      "Residential and commercial service pages with province-specific rebate content",
  ...
  },
  {
    ...
    stack: ["Next.js", "TypeScript", "Tailwind CSS", "Provincial rate data", "Lead capture"],
    ...
    insight: [
      ...
      "Built as a standalone lead-generation tool",
    ],
    challenge:
