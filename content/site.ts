...
export const toolkit = [
  { group: "Frontend", items: ["React", "Next.js", "TypeScript", "Tailwind CSS", "Framer Motion", "Vue.js"] },
  { group: "Backend", items: ["Node.js", "Python", "FastAPI", "PHP", "REST APIs", "Celery"] },
...
export const principles = [
  { n: "01", title: "Understand before building", body: "I start with the data model and the user's job to be done. Most bugs are misunderstandings, so I remove them early." },
  { n: "02", title: "Ship in phases", body: "Clear milestones with a working deliverable at each step. You see progress weekly, not at the end." },
  { n: "03", title: "Leave it maintainable", body: "Typed code, tests where they matter, structured repos, and handoff docs. You are never locked in." },
];
